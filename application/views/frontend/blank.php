    ...
    <div class="breadcrumbs">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center">
                <h2 class="text-dark">Apakah anda butuh bantuan ?</h2>
                <ol>
                    <li><a href="<?php echo base_url('utama') ?>">Home</a></li>
                    <li class="text-dark">Tata Cara Daftar</li>
                </ol>
            </div>
        </div>
    </div>
                    ...
                    <div class="accordion accordion-flush px-xl-5" id="faqlist">
                        <div class="accordion-item" data-aos="fade-up" data-aos-delay="200">
                            <h3 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-1">
                                    ...
                                    Apakah Pendaftaran ini berbayar ?
                                </button>
                            </h3>
                        ...
                        <div class="accordion-item" data-aos="fade-up" data-aos-delay="300">
                            <h3 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-2">
                                    <i class="bi bi-question-circle question-icon"></i>
                                    Terjadi error ketika mau masuk ke menu pendaftaran ?
                                </button>
                            </h3>
                            <div id="faq-content-2" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                <div class="accordion-body">
                                    di harap untuk merefresh terlebih dahulu browser anda, dan pastikan kuota internet anda lancar.
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="accordion-item" data-aos="fade-up" data-aos-delay="500">
                            <h3 class="accordion-header">
                                <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faq-content-4">
                                    <i class="bi bi-question-circle question-icon"></i>
                                    Ada kesalahan ketika menginput data pendaftaran ?
                                </button>
                            </h3>
                        ...
                        <div class="accordion-item" data-aos="fade-up" data-aos-delay="600">
                            ...
                            <div id="faq-content-5" class="accordion-collapse collapse" data-bs-parent="#faqlist">
                                <div class="accordion-body">
                                    jika sudah mendaftar itu berarti data kamu sudah masuk di sistem kami yah.
                                    untuk seleksi selanjutnya akan kami hubungi melalui email dan no.hp kamu.
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-5 align-items-stretch order-1 order-lg-2 img" style="background-image: url('<?php echo base_url() ?>assets/frontend/img/form.jpg');height:100px;width:390px;">&nbsp;</div>
            </div>
        </div>
    </section>
</main><!-- .animated -->