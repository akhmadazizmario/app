      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?= base_url('alasan_masuk_panti/update/' . $row['id_alasan']); ?>" method="post" enctype="multipart/form-data">

              <div class="form-group">
                <label for="alasan"> Alasan Masuk Panti </label><br>
                <input class="form-control" id="alasan" type="text" name="alasan" value="<?= $row['alasan'] ?>" required oninvalid="this.setCustomValidity('Alasan Masuk Panti Wajib Diisi')" oninput="this.setCustomValidity('')">
              </div>
