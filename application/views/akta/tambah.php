      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?= base_url('akta/save'); ?>" method="post" enctype="multipart/form-data">


              <div class="form-group">
                <label for="akta">Akta</label><br>
                <input class="form-control" id="akta" type="text" name="akta" placeholder="Masukkan Akta" required oninvalid="this.setCustomValidity('Akta Wajib Diisi')" oninput="this.setCustomValidity('')" autofocus>
              </div>
