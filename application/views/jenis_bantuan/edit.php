      ...
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php endif; ?>
            <form action="<?= base_url('jenis_bantuan/update/' . $row['id_bantuan']); ?>" method="post" enctype="multipart/form-data">

              <div class="form-group">
                <label for="jenis_bantuan"> Jenis Bantuan </label><br>
                <input class="form-control" id="bantuan" type="text" name="bantuan" value="<?= $row['bantuan'] ?>" required oninvalid="this.setCustomValidity('Jenis Bantuan Wajib Diisi')" oninput="this.setCustomValidity('')">
              </div>
