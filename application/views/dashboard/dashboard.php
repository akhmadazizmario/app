      ...
      <div class="col-md-12">
        ...
        var myChart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
                label: "Logistik",
                data: [<?= $dljanuari->num_rows() ?>, <?= $dlfebruari->num_rows() ?>, <?= $dlmaret->num_rows() ?>,
                  <?= $dlapril->num_rows() ?>, <?= $dlmei->num_rows() ?>, <?= $dljuni->num_rows() ?>,
                  <?= $dljuli->num_rows() ?>, <?= $dlagustus->num_rows() ?>, <?= $dlseptember->num_rows() ?>,
                  <?= $dloktober->num_rows() ?>, <?= $dlnovember->num_rows() ?>, <?= $dldesember->num_rows() ?>
                ],
              ...
              {
                label: "Uang",
                data: [<?= $dujanuari->num_rows() ?>, <?= $dufebruari->num_rows() ?>, <?= $dumaret->num_rows() ?>,
                  <?= $duapril->num_rows() ?>, <?= $dumei->num_rows() ?>, <?= $dujuni->num_rows() ?>,
                  <?= $dujuli->num_rows() ?>, <?= $duagustus->num_rows() ?>, <?= $duseptember->num_rows() ?>,
                  <?= $duoktober->num_rows() ?>, <?= $dunovember->num_rows() ?>, <?= $dudesember->num_rows() ?>
                ],
  ...
  <div class="col-md-12">
    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          label: "Surat Masuk",
          data: [<?= $januari->num_rows() ?>, <?= $februari->num_rows() ?>, <?= $maret->num_rows() ?>,
            <?= $april->num_rows() ?>, <?= $mei->num_rows() ?>, <?= $juni->num_rows() ?>,
            <?= $juli->num_rows() ?>, <?= $agustus->num_rows() ?>, <?= $september->num_rows() ?>,
            <?= $oktober->num_rows() ?>, <?= $november->num_rows() ?>, <?= $desember->num_rows() ?>
          ],
          ...
          label: "Surat Keluar",
          data: [<?= $sjanuari->num_rows() ?>, <?= $sfebruari->num_rows() ?>, <?= $smaret->num_rows() ?>,
            <?= $sapril->num_rows() ?>, <?= $smei->num_rows() ?>, <?= $sjuni->num_rows() ?>,
            <?= $sjuli->num_rows() ?>, <?= $sagustus->num_rows() ?>, <?= $sseptember->num_rows() ?>,
            <?= $soktober->num_rows() ?>, <?= $snovember->num_rows() ?>, <?= $sdesember->num_rows() ?>
          ],
          backgroundColor: 'transparent',
          borderColor: 'rgba(40,167,69,0.75)',
          borderWidth: 3,
    ...
    var myChart = new Chart(ctx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          data: [<?= $tujuhbelas->num_rows() ?>, <?= $delapanbelas->num_rows() ?>,
            <?= $sembilanbelas->num_rows() ?>, <?= $sekarang->num_rows() ?>
          ],
