              ...
              <div class="card-body">
                ...
                <form action="<?= base_url('keuangan/save'); ?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="form-group">
                    ...
                    <input class="form-control" id="tgl_keuangan" type="date" name="tgl_keuangan" placeholder="Masukkan Tanggal" required oninvalid="this.setCustomValidity('Tanggal Wajib Diisi')" oninput="this.setCustomValidity('')">
                  </div>

                  <div class="form-group">
                    <label for="keterangan">Keterangan</label><br>
                    <input class="form-control" id="keterangan" type="text" name="keterangan" placeholder="Masukkan Keterangan" required oninvalid="this.setCustomValidity('Keterangan Wajib Diisi')" oninput="this.setCustomValidity('')">
                  </div>

                  <div class="form-group">
                    <label for="jumlah_uang">Jumlah Uang (Rp)</label><br>
                    <input class="form-control" id="jumlah_uang" type="number" name="jumlah_uang" placeholder="Masukkan Jumlah Uang" required oninvalid="this.setCustomValidity('Jumlah Uang Wajib Diisi')" oninput="this.setCustomValidity('')">
                  </div>

                  <div class="form-group">
                    <label for="type"> Type </label><br>
                    <select class="form-control" name="type" required oninvalid="this.setCustomValidity('Pilih Jenis type')" oninput="setCustomValidity('')">
